...
func (h *BackupHandlers) ListJobs(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: jobs})
}
...
func (h *BackupHandlers) CreateJob(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: createdJob})
}
...
func (h *BackupHandlers) GetJob(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: job})
}
...
func (h *BackupHandlers) UpdateJob(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: updatedJob})
}
...
func (h *BackupHandlers) DeleteJob(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Message: "Job deleted successfully"})
}
...
func (h *BackupHandlers) RunJob(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Message: "Job started successfully"})
}
...
func (h *BackupHandlers) CancelJob(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Message: "Job cancelled successfully"})
}
...
func (h *BackupHandlers) GetHistory(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: history})
}
...
func (h *BackupHandlers) GetStorage(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: storage})
}
...
func (h *BackupHandlers) GetStatistics(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: stats})
}
...
func (h *BackupHandlers) GetActiveRecoveries(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: recoveries})
}
...
func (h *BackupHandlers) GetAlerts(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Data: alerts})
}
...
func (h *BackupHandlers) VerifyBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Message: "Backup verification started"})
}
...
func (h *BackupHandlers) StartRecovery(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true,
...
func (h *BackupHandlers) DeleteBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Message: "Backup deleted successfully"})
}
...
func (h *BackupHandlers) UpdateSchedule(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(response.APIResponse{Success: true, Message: "Schedule updated successfully"})
}
